...
logo = fig.renderText(f'ELECTRAOP')
print(logo)
...
def check_email(email):
	...
	bo = f'\x1b[38;5;{b}m'
	check+=1
	sys.stdout.write(f"\r— — — — — — — — — — — — — — —                                        {C}Good HMAIL : {F}{good_hot}                                                                                                       {C}Bad IG : {R}{bad_ig}                                                                                                             {C}Good IG : {X}{good_ig}                                                                                                           {C}{bo}Check•{check}                                                                                                              — — — — — — — — — — — — — — —\r")
	sys.stdout.flush()
